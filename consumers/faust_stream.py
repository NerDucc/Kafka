...
topic = app.topic("com.udacity.ducnv104.project1.cta.stations", value_type=Station)
# TODO: Define the output Kafka Topic
out_topic = app.topic("com.udacity.ducnv104.project1.cta.stations.transformed", 
                      partitions=1,
                      key_type=str,
                      value_type=TransformedStation)
# TODO: Define a Faust Table
table = app.Table(
   name="transform_station_hpping",
