...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        #
        #
        topic_name = f"com.udacity.ducnv104.project1.train_arrival.{station_name}" # TODO: Come up with a better topic name
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        station_value = {
            ...
            "direction": direction,
            "line": self.color.name, # I think it should be self.color
